...
class Main:
    ...
    def run(self):
        ...
        # Setting up engine
        player_1 = self.physicsEngine.addCharacter(Cyborg("player1", 100, "graphics/cyborg/cyborg_base.png", 1), (10, 200))
        player_2 = self.physicsEngine.addCharacter(Cyborg("player2", 100, "graphics/cyborg/cyborg_base.png", 2), (550, 200))
